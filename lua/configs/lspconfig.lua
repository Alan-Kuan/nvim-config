...
local on_attach = function(_, bufnr)
    ...
    buf_map('n', '[d', ':lua vim.diagnostic.goto_prev()<CR>', opts)
    buf_map('n', ']d', ':lua vim.diagnostic.goto_next()<CR>', opts)
    buf_map('n', '<leader>q', ':lua vim.diagnostic.set_loclist()<CR>', opts)
