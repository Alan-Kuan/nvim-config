local on_attach = function(_, bufnr)
    ...
    buf_map('n', '<space>rn', ':lua vim.lsp.buf.rename()<CR>', opts)
    buf_map('n', '[d', ':lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
    buf_map('n', ']d', ':lua vim.lsp.diagnostic.goto_next()<CR>', opts)
    buf_map('n', '<space>q', ':lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
    buf_map('n', '<space>f', ':lua vim.lsp.buf.formatting()<CR>', opts)
    buf_map('n', '<space>ca', ':lua vim.lsp.buf.code_action()<CR>', opts)
